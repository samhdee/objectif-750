...
class DaysStatsController extends Controller
{
  public function daysProgressAction() {
    ...
    if($nano_mode) {
      ...
      // (on omet les mots du jour volontairement)
      ...
      // $total_nano_words = $total_nano_words + $todays_word_count;
      $percent_nano_accomplished = ceil(($total_nano_words + $todays_word_count) * 100 / 50000);
